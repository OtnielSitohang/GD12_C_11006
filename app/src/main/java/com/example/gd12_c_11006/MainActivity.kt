package com.example.gd12_c_11006
...
import com.example.gd12_c_11006.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun createPdf(nama: String, umur: String, tlp: String, alamat: String, kampus: String) {
        ...
        @SuppressLint("UseCompatLoadingForDrawables") val d = getDrawable(R.drawable.side_profile)
